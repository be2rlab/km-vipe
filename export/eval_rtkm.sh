...
export SCENE_NAMES=(office1) #office0 office1 office2 office3 office4 room0 room1 room2)
export SCENE_NAMES_UNDERSCORE=(office_1) #office_0 office_1 office_2 office_3 office_4 room_0 room_1 room_2)
...
for ((i=0; i<length; i++)); do
    ...
    python /eval/eval_semseg.py \
        ...
        --excluded_classes "0" \
        --pred_pc_path "/home/user/km-vipe/vipe_results/vipe/v2/${scene_name}" \
        --gt_pc_path "/data/gt/replica/${scene_name_underscore}/habitat/mesh_semantic.ply" \
        --output_path "/home/user/km-vipe/vipe_results/rtkm/replica/v2" \
...
python /eval/compute_metrics.py \
    --results_dir "/home/user/km-vipe/vipe_results/rtkm/replica/v2" \
    --excluded "-1 0" \
    --chunks '{
